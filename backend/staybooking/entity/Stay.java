...
public class Stay implements Serializable {
    ...
    public Stay setName(String name) {
        this.name = name;
        return this;
    }

    public Stay setDescription(String description) {
        this.description = description;
        return this;
    }

    public Stay setAddress(String address) {
        this.address = address;
        return this;
    }

    public Stay setGuestNumber(int guestNumber) {
        this.guestNumber = guestNumber;
        return this;
    }

    public Stay setHost(User host) {
        this.host = host;
        return this;
    }
